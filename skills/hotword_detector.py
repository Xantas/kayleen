...
from definitions import HOTWORD_RESOURCES_DIR
from skills.player import Player

if platform.system() == 'Darwin':
    from device.snowboy.darwin import snowboydetect
else:
    from device.snowboy.raspberry import snowboydetect

RESOURCE_FILE = os.path.join(HOTWORD_RESOURCES_DIR, "common.res")
DECODER_MODEL = os.path.join(HOTWORD_RESOURCES_DIR, "kayleen.pmdl")
...
class SnowboyDecoder(object):
    ...
    def __init__(self, decoder_model=DECODER_MODEL,
